...
```
>
We notice that the file we provide is checked and then reopened and used for read after, which enable us to use  <span style="color: red; font-weight:bold;"> TOCTOU technique </span>
{: .prompt-danger}
